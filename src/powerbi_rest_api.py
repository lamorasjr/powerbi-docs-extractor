...
def get_auth_token(tenant_id:str, client_id:str, client_secret:str):
...
def get_workspaces_info(access_token:str, workspace_id:str):
...
def get_workspace_reports(access_token:str, workspace_id:str):
...
def get_workspace_datasets(access_token:str, workspace_id:str):
...
def execute_dataset_query(access_token:str, workspace_id:str, dataset_id:str, dax_query:str):
